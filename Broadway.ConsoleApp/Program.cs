...
namespace Broadway.ConsoleApp
{
    class Program
    {
        ...
        private const string SecurityKey = "bfc4ae7f-1116-4b57-b6e3-5edd5dc35ea6";
        ...
        static void PasswordEncryptionAndDecryption()
        {
            string str = "This is test string.";
            string encryptedText=EncryptPlainTextToCipherText(str);
            Console.WriteLine("Encrypted Text"+encryptedText);

            //var falsedecryptedText = DecryptCipherTextToPlainText(encryptedText, "bfc4ae7f-1116-4b57-b6e3-5edd5dc35ea7");
            //Console.WriteLine("False Decryption => "+falsedecryptedText);

            var decryptedText = DecryptCipherTextToPlainText(encryptedText, "bfc4ae7f-1116-4b57-b6e3-5edd5dc35ea6");
